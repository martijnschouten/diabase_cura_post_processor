...
class PauseAtHeight(Script):
    ...
    def execute(self, data: List[str]) -> List[str]:
        ...
        Logger.log("w", 'initial_layer_height: ' + str(initial_layer_height))
        ...
        if pause_at == "height":          
            pause_layer = floor((pause_height-initial_layer_height+0.0001)/layer_height)+1
        ...
        for index, layer in enumerate(data):
            ...
            for line in lines:
                ...
                Logger.log("w", 'new layer found, number: ' + str(current_layer))
                try:
