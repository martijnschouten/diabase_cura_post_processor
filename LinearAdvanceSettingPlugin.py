...
class LinearAdvanceSettingPlugin(Extension):
    ...
    def _filterGcode(self, output_device: "OutputDevice") -> None:
        ...
        Logger.log("w", "extruder count:" + str(extruder_count))
        start_at_zero = True
        if extruder_count > 2:
            start_at_zero = False
        
        Logger.log("w", "start at zero: " + str(start_at_zero))
        ...
        for plate_id in gcode_dict:
            ...
            for extruder_stack in used_extruder_stacks:
                ...
                if start_at_zero:
                    ...
                    gcode_list[1] = gcode_list[1] + gcode_command_pattern % (linear_advance_factor, extruder_nr+1) + "\n"
                dict_changed = True
                            ...
                            for extruder_stack in used_extruder_stacks:
                                ...
                                if linear_advance_factor != current_linear_advance_factors.get(extruder_nr, None):
                                    ...
                                    if start_at_zero:
                                        ...
                                        lines.insert(line_nr + 1, gcode_command_pattern % (linear_advance_factor, extruder_nr+1))
                                    lines_changed = True
